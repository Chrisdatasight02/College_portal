...
<table class="table table-bordered table-striped table-hover" class="btn btn-primary">
	<thead>
			<tr>
				
  <th>id</th> <th>Salutation</th> <th>First name</th> <th>Last name</th> <th>Gender</th> <th>Email</th> <th>Date of birth</th> <th>Address</th> 
	   <th>Actions</th>
	    <th>Actions</th>
			</tr>
...
<tbody>
	...
	<td><?=$array_data[0]?> </td>  <td><?=$array_data[1]?></td>   <td><?=$array_data[2]?></td> <td><?=$array_data[3]?></td> <td><?=$array_data[4]?></td> <td><?=$array_data[5]?></td> <td><?=$array_data[6]?></td> <td><?=$array_data[7]?></td>
	                <td>
	      <a href="delete_file.php?id=<?=$array_data[0]?>">Delete</a>
	                </td>
	                <td>
	     <a href="edit_file.php?id=<?=$array_data[0]?>">Edit</a>
	                </td>
	                <?php
					} 
